...
root.geometry("400x390")  # Aumentei um pouco a altura para caber o novo botão
...
# NOVA MODALIDADE ADICIONADA ABAIXO:
tk.Radiobutton(root, text="Taxa Pré-fixada", variable=modalidade_var, value=3).pack()


tk.Label(root, text="Prazo em dias úteis (1 a 10000):", font=("Arial", 10, "bold")).pack(pady=(10,5))
tk.Entry(root, textvariable=prazo_var, justify="center").pack()


tk.Label(root, text="Taxa negociada (ex: 110, 1.5 ou 11):", font=("Arial", 10, "bold")).pack(pady=(10,5))
...
# NOVA LÓGICA DE CÁLCULO INCLUÍDA NO BACKEND:
elif modalidade == 3:
